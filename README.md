# EX-spa_JS_EVENT_LISTENERS_WYSIWYG


## Instructions

XdoneX - Create an array of objects that represents famous people (see structure below).

XdoneX - Create a text input in your DOM.

XdoneX - Beneath that, create a container, block element in your DOM.

XdoneX - Create a DOM element for each of the objects inside the container. Style your person elements however you like.

XdoneX - For every even numbered element, have a light yellow background.

XdoneX - For every odd numbered element, have a light blue background.
...
XdoneX - When you click on one of the person elements, the text input should immediately gain focus so that you can start typing.

XdoneX - When there is a highlighted person element, and you begin typing in the input box, the person's biography should be immediately bound to what you are typing, letter by letter.

XdoneX - When you press the enter/return key when typing in the input field, then the content of the input field should immediately be blank.
